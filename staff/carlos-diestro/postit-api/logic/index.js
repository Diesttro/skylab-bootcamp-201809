...
const logic = {
     ...
     */
    addPostit(id, text) {
        if (typeof id !== 'string') throw TypeError(`${id} is not a number`)
    ...
    removePostit(id, postitId) {
        if (typeof id !== 'string') throw TypeError(`${id} is not a number`)
        if (typeof postitId !== 'string') throw TypeError(`${postitId} is not a number`)
    ...
    retrieveUserPostit(userId, postitId) {
